...
class AlignedDatasetUpload(BaseDataset):
    def initialize(self, opt):
        ...
        self.dataset_size = len(open('upload.txt').readlines())

        dir_I = '_img'
        self.dir_I = os.path.join(opt.dataroot, "upload" + dir_I)

        dir_C = '_clothes'
        self.dir_C = os.path.join(opt.dataroot, "upload" + dir_C)

        dir_E = '_edge'
        self.dir_E = os.path.join(opt.dataroot, "upload" + dir_E)
