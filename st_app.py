...
human_image_names = sorted([fn[:-4] for fn in os.listdir('dataset/VITON-HD/test/image')])
...
if st.sidebar.checkbox('Upload'):
    ...
    if human_file is None:
        human_file = 'dataset/VITON-HD/test/image/00006_00.png'
else:
    human_image_name = st.sidebar.selectbox("Choose a Human Image", human_image_names)
    human_file = f'dataset/VITON-HD/test/image/{human_image_name}.png'
